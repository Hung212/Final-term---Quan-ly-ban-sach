...
{
    public partial class formChiTiet_TheLoaiSach : Form
    {
        
        
        Repos.repo_ChiTiet_TheLoaiSach repo = new Repos.repo_ChiTiet_TheLoaiSach();
        DataTable source;
        ...
        List<Tuple<myEvents, ChiTiet_TheLoaiSach>> userEvent = new List<Tuple<myEvents, ChiTiet_TheLoaiSach>>();
        
        public formChiTiet_TheLoaiSach()
        {
            InitializeComponent();
        }
        ...
        // Chuyển giá trị trong Textbox thành ChiTiet_TheLoaiSach
        public ChiTiet_TheLoaiSach Textbox_To_ChiTiet_TheLoaiSach()
        {
            try
            {
        ...
        // Chuyển giá trị trong DataGridView thành ChiTiet_TheLoaiSach
        public ChiTiet_TheLoaiSach DataGridView_To_ChiTiet_TheLoaiSach(int index)
        {
            try
            {
                ChiTiet_TheLoaiSach result = new ChiTiet_TheLoaiSach();
        ...
        {
			FunctionHelper.ExportExcel(ref this.dgvData, "ChiTiet_TheLoaiSach");
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var record = Textbox_To_ChiTiet_TheLoaiSach();
                var result = repo.Delete(record);

                if (result)
                {
                    ShowMessage("Xoá bản ghi thành công!", result);
                    userEvent.Add(new Tuple<myEvents, ChiTiet_TheLoaiSach>(myEvents.Delete, record));
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var result = repo.Update(Textbox_To_ChiTiet_TheLoaiSach());

                if (result)
                {
                    ShowMessage("Cập nhật bản ghi thành công!", result);
                    userEvent.Add(new Tuple<myEvents, ChiTiet_TheLoaiSach>(myEvents.Update, DataGridView_To_ChiTiet_TheLoaiSach(dgvData.SelectedRows[0].Index)));
                    btnLamMoi_Click(sender, e);
                }
                else
                {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result)
                {
                    ...
                    userEvent.Add(new Tuple<myEvents, ChiTiet_TheLoaiSach>(myEvents.Insert, record));
                    btnLamMoi_Click(sender, e);
                }
                else
                {
        ...
        {
			source = FunctionHelper.ToDataTable<ChiTiet_TheLoaiSach>(repo.FindAll());
        ...
        private void formChiTiet_TheLoaiSach_Load(object sender, EventArgs e)
        {
            btnLamMoi_Click(sender, e);
        }
        ...
        private void formChiTiet_TheLoaiSach_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (this.Owner != null)
        ...
        private void formChiTiet_TheLoaiSach_EnabledChanged(object sender, EventArgs e)
        {
            try
            {
