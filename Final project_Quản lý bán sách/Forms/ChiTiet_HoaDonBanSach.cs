...
{
    public partial class formChiTiet_HoaDonBanSach : Form
    {
        
        
        Repos.repo_ChiTiet_HoaDonBanSach repo = new Repos.repo_ChiTiet_HoaDonBanSach();
        DataTable source;
        ...
        List<Tuple<myEvents, ChiTiet_HoaDonBanSach>> userEvent = new List<Tuple<myEvents, ChiTiet_HoaDonBanSach>>();
        
        public formChiTiet_HoaDonBanSach()
        {
            InitializeComponent();
        }
        ...
        // Chuyển giá trị trong Textbox thành ChiTiet_HoaDonBanSach
        public ChiTiet_HoaDonBanSach Textbox_To_ChiTiet_HoaDonBanSach()
        {
            try
            {
        ...
        // Chuyển giá trị trong DataGridView thành ChiTiet_HoaDonBanSach
        public ChiTiet_HoaDonBanSach DataGridView_To_ChiTiet_HoaDonBanSach(int index)
        {
            try
            {
                ChiTiet_HoaDonBanSach result = new ChiTiet_HoaDonBanSach();
        ...
        {
			FunctionHelper.ExportExcel(ref this.dgvData, "ChiTiet_HoaDonBanSach");
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var record = Textbox_To_ChiTiet_HoaDonBanSach();
                var result = repo.Delete(record);

                if (result)
                {
                    ShowMessage("Xoá bản ghi thành công!", result);
                    userEvent.Add(new Tuple<myEvents, ChiTiet_HoaDonBanSach>(myEvents.Delete, record));
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var result = repo.Update(Textbox_To_ChiTiet_HoaDonBanSach());

                if (result)
                {
                    ShowMessage("Cập nhật bản ghi thành công!", result);
                    userEvent.Add(new Tuple<myEvents, ChiTiet_HoaDonBanSach>(myEvents.Update, DataGridView_To_ChiTiet_HoaDonBanSach(dgvData.SelectedRows[0].Index)));
                    btnLamMoi_Click(sender, e);
                }
                else
                {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result)
                {
                    ...
                    userEvent.Add(new Tuple<myEvents, ChiTiet_HoaDonBanSach>(myEvents.Insert, record));
                    btnLamMoi_Click(sender, e);
                }
                else
                {
        ...
        {
			source = FunctionHelper.ToDataTable<ChiTiet_HoaDonBanSach>(repo.FindAll());
        ...
        private void formChiTiet_HoaDonBanSach_Load(object sender, EventArgs e)
        {
            btnLamMoi_Click(sender, e);
        }
        ...
        private void formChiTiet_HoaDonBanSach_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (this.Owner != null)
        ...
        private void formChiTiet_HoaDonBanSach_EnabledChanged(object sender, EventArgs e)
        {
            try
            {
